        ...
        <div>
          ...
          <div className="flex items-start gap-6 mb-8">
            ...
            <div className="flex-1 pt-1">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Télécharger une photo de profil ou un avatar</p>
            </div>
          </div>
          ...
          {/* Bio Input */}
          <div className="mb-8">
            <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Biographie</label>
            <div className="relative group">
