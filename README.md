...
<div align="center">
  <details>
    <summary><strong>🔑 Variables d'environnement importantes</strong></summary>
    <br>
    <table>
      <tr>
        <td><code>OPENAI_API_KEY</code></td>
        <td>Clé API OpenAI (GPT-4)</td>
      </tr>
      <tr>
        <td><code>ANTHROPIC_API_KEY</code></td>
        <td>Clé API Anthropic (Claude)</td>
      </tr>
      <tr>
        <td><code>GOOGLE_GENERATIVE_AI_API_KEY</code></td>
        <td>Clé API Google (Gemini)</td>
      </tr>
      <tr>
